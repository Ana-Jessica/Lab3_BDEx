    ...
    <div class="ldld">
        ...
        <main>
            <article class="artcadastro" style="display: none;">
                ...
                <form action="edit_dds_empresa.php" method="POST">
                    <box-inputset>
                        ...
                        <br />
                        <button id="form-editar" type="submit" id="update" name="update"
                ...
                <div class="modal_default">
                    <div class="modal-content">
                        <p>Tem certeza de que deseja editar os dados? Verifique se os dados, como email, estão
                            preenchidos corretamente.</p>
                        <button onclick="confirmarModal(true)">Confirmar</button>
                        <button onclick="confirmarModal(false)">Cancelar</button>
                    </div>
                </div>
            ...
            <article class="artvagas" style="display: flex;">
                ...
                <button class="criarvaga">Nova vaga <i class="bi bi-plus"></i></button>
                <br>
                <h3>vagas que voce criou:</h3>
                <div class="modalvaga">
